...
('lt000000-0000-0000-0000-00000000000a', '22222222-2222-2222-2222-222222222222', NULL, '頑張って', '頑張って！あなたは思っているより強いです。一歩ずつ前進しましょう。応援しています！💪', '頑張って！あなたは思っているより強いです。一歩ずつ前進しましょう。応援しています！💪', 'PUBLIC', FALSE, '#2A1F00', '#FFFF00', 'Kosugi Maru', 15.0, NULL, NOW() - INTERVAL 32 DAY, 51, FALSE, NULL, NOW() - INTERVAL 32 DAY, NOW() - INTERVAL 32 DAY, NULL),
...
('lt000000-0000-0000-0000-00000000000c', '44444444-4444-4444-4444-444444444444', NULL, '素敵な一日', '素敵な一日をお過ごしください。小さな幸せを見つけて、心温まる時間を過ごしましょう。💝', '素敵な一日をお過ごしください。小さな幸せを見つけて、心温まる時間を過ごしましょう。💝', 'PUBLIC', FALSE, '#1E1A14', '#FFFFFF', 'Comic Neue', 15.0, NULL, NOW() - INTERVAL 36 DAY, 53, FALSE, NULL, NOW() - INTERVAL 36 DAY, NOW() - INTERVAL 36 DAY, NULL),
