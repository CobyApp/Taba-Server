...
('l1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', NULL, '안녕하세요!', '오늘 날씨가 정말 좋네요. 모두 행복한 하루 되세요! 봄이 오는 것 같아서 기분이 좋아요. 🌸', '오늘 날씨가 정말 좋네요. 모두 행복한 하루 되세요! 봄이 오는 것 같아서 기분이 좋아요. 🌸', 'PUBLIC', FALSE, '#1D1433', '#FFFFFF', 'Jua', 16.0, NULL, NOW() - INTERVAL 2 DAY, 15, FALSE, NULL, NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 2 DAY, NULL);

-- 공개 편지 2 (밥이 작성, 1일 전 발송)
INSERT INTO letters (id, sender_id, recipient_id, title, content, preview, visibility, is_anonymous, template_background, template_text_color, template_font_family, template_font_size, scheduled_at, sent_at, views, is_read, read_at, created_at, updated_at, deleted_at) VALUES
('l2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', NULL, '좋은 아침입니다', '오늘도 화이팅! 모두 좋은 하루 되세요. 새로운 시작이 기대됩니다. 💪', '오늘도 화이팅! 모두 좋은 하루 되세요. 새로운 시작이 기대됩니다. 💪', 'PUBLIC', FALSE, '#2A1F00', '#FFFF00', 'Sunflower', 15.0, NULL, NOW() - INTERVAL 1 DAY, 8, FALSE, NULL, NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY, NULL);

-- 공개 편지 3 (찰리가 작성, 익명, 3시간 전 발송)
INSERT INTO letters (id, sender_id, recipient_id, title, content, preview, visibility, is_anonymous, template_background, template_text_color, template_font_family, template_font_size, scheduled_at, sent_at, views, is_read, read_at, created_at, updated_at, deleted_at) VALUES
('l3333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', NULL, '행복한 하루', '모두 행복한 하루 되세요! 긍정적인 에너지가 가득하길 바랍니다. 작은 것에도 감사하는 마음을 가지세요. ✨', '모두 행복한 하루 되세요! 긍정적인 에너지가 가득하길 바랍니다. 작은 것에도 감사하는 마음을 가지세요. ✨', 'PUBLIC', TRUE, '#1A0016', '#FF00FF', 'Yeon Sung', 16.0, NULL, NOW() - INTERVAL 3 HOUR, 3, FALSE, NULL, NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 3 HOUR, NULL);
