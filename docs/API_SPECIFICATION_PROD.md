...
> **참고**: 이 문서는 프로덕션 환경용 API 명세서입니다. 개발 환경은 [API_SPECIFICATION_DEV.md](API_SPECIFICATION_DEV.md)를 참고하세요.
...
```json
{
  ...
  "data": {
    ...
    "email": "user@example.com",
    "nickname": "사용자",
    "profileImageUrl": "https://www.taba.asia/api/v1/files/{fileId}",
    ...
    "letters": [
      {
        "id": "uuid",
        "content": "편지 내용",
        "imageUrl": "https://www.taba.asia/api/v1/files/{fileId}",
...
```json
{
  ...
  "data": {
    "fileId": "uuid",
    "url": "https://www.taba.asia/api/v1/files/{fileId}"
  }
}
```
...
프로덕션 환경에서 다음 URL에서 인터랙티브 API 문서를 확인할 수 있습니다:
